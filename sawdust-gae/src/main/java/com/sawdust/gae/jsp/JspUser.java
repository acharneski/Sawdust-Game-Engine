...
public class JspUser implements Serializable
{
    ...
    private com.sawdust.gae.logic.User user = null;
    ...
    public com.sawdust.gae.datastore.entities.Account getAccount()
    {
        initUser();
        if(null == _account) 
        {
    ...
    public com.sawdust.gae.logic.User getUser()
    {
        initUser();
        return user;
    }
    ...
    private void initUser()
    {
        ...
        user = com.sawdust.gae.logic.User.getUser(_request, _response, null);
