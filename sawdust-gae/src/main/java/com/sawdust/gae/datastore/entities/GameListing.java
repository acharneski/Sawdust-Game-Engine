...
public class GameListing extends DataObj
{
    ...
    public static GameListing get(final HashMap<InviteSearchParam, String> searchParameters) throws com.sawdust.engine.view.GameException
    {
        return list(searchParameters, 1).get(0);
    }

    public static ArrayList<GameListing> list(final HashMap<InviteSearchParam, String> searchParameters, final int numberToList) throws com.sawdust.engine.view.GameException
    {
        ...
        try
        {
            ...
            for (final GameListing gameListing : results)
            {
                ...
                if(null != gameSession)
                {
                    ...
                    if(gameSession.getStatus() == com.sawdust.engine.controller.entities.GameSession.SessionStatus.Inviting)
                    {
