...
import com.sawdust.gae.datastore.entities.PromoRedemption.MemberStatus;

@PersistenceCapable(identityType = IdentityType.APPLICATION, detachable = "true")
public class Promotion extends DataObj implements com.sawdust.engine.controller.entities.Promotion
{
    ...
    public static Promotion load(final Account paccount, PromotionConfig p) throws GameException
    {
        ...
        self._message = self._message.replaceAll("PROMOLINK", self.getFullUrl());
        self._attachment = self._attachment.replaceAll("PROMOLINK", self.getFullUrl());
    ...
    protected Promotion(final Account paccount, PromotionConfig p) throws GameException
    {
        ...
        final PromoRedemption sessionMember = new PromoRedemption(this, (com.sawdust.gae.datastore.entities.Account) paccount);
    ...
    public void addAccount(final com.sawdust.engine.controller.entities.Account _account) throws GameLogicException
    {
        ...
        final PromoRedemption sessionMember = new PromoRedemption(this, (com.sawdust.gae.datastore.entities.Account) _account);
        sessionMember.memberIndex = members.size();
        sessionMember.setMemberStatus(MemberStatus.Waiting);
