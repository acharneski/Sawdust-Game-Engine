...
public abstract class EuchreGame extends MultiPlayerCardGame
{
    ...
    public boolean isInPlay()
    {
        ...
        if (getCurrentPhase().equals(com.sawdust.engine.game.euchre.EuchreGame.COMPLETE)) return false;
        if (getCurrentPhase().equals(com.sawdust.engine.game.euchre.EuchreGame.DEALING)) return false;
        if (getCurrentPhase().equals(com.sawdust.engine.game.euchre.EuchreGame.FORMING)) return false;
        return true;
    }
