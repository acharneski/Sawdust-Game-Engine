...
import com.sawdust.engine.common.geometry.ParametricLine;
import com.sawdust.engine.common.geometry.ParametricPosition;
...
import com.sawdust.engine.game.poker.ai.Stupid1;
...
public abstract class PokerGame extends MultiPlayerCardGame
{
    ...
    public boolean isInPlay()
    {
        ...
        if (getCurrentPhase().equals(com.sawdust.engine.game.poker.PokerGame.GamePhase.Complete)) return false;
        if (getCurrentPhase().equals(com.sawdust.engine.game.poker.PokerGame.GamePhase.Null)) return false;
        return true;
    }
